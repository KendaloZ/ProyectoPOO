...
public class MedicamentoDAO {
        ...
        try {
            ...
            try (Connection con = Conexion.getConnection()) {
                try (PreparedStatement ps = con.prepareStatement(sql)) {
                    ...
                    var6 = new Medicamento(rs.getInt("id"), rs.getString("nombre"), rs.getBoolean("disponible"));
                }
            }
    ...
    public List<Medicamento> obtenerTodos() {
        ...
        try (
            ...
            while(rs.next()) {
                lista.add(new Medicamento(rs.getInt("id"), rs.getString("nombre"), rs.getBoolean("disponible")));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
